...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <title>بوابة التسجيل في مسابقة التوظيف</title>
...
<div dir="ltr" class="input-group"><input type="text" id="nom_diplome" class="form-control keyboardInput" name="nom_diplome"  oninvalid="this.setCustomValidity('حقل إجباري')" oninput="setCustomValidity('');changer_lettre(this.id)" required value="<?php  echo $nom_diplom;?>"/> 
...
<div dir="ltr" class="input-group"><input type="text" id="nom_filiere" class="form-control keyboardInput" name="nom_filiere"  oninvalid="this.setCustomValidity('حقل إجباري')" oninput="setCustomValidity('');changer_lettre(this.id)" required value="<?php  echo $nom_filiere;?>"  /> 
...
<div dir="ltr" class="input-group"><input type="text" id="nom_specialite" class="form-control keyboardInput" name="nom_specialite"  oninvalid="this.setCustomValidity('حقل إجباري')" oninput="setCustomValidity('');changer_lettre(this.id)" required value="<?php  echo $nom_specialite;?>"/> 
...
مجموع معدل السنوات</th>
  ...
  <tr>
   ...
   <td  valign="top"><input type="text"  class="form-control" name="pr_anmy"  onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value=" <?php echo $pr_anmy;?>" /></td>
   <td  valign="top"><input type="number"  class="form-control" name="pr_an2sm"  onblur="maxval(this,20); " step="any" value="<?php echo $pr_an2sm;?>" onfocus="this.select()"/></td>
   <td  valign="top"><input type="number" min="0" max="20"     class="form-control" name="pr_an1sm" onblur="maxval(this,20); "  step="any" value="<?php echo $pr_an1sm;?>" onfocus="this.select()"/> </td>
        
    <td valign="top">01</td>
  </tr>
  
   <tr>
     <td  valign="top"><input type="text"  class="form-control" name="dz_anmy"  onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $dz_anmy;?>"/></td>
     <td  valign="top"><input type="number" class="form-control" step="any" name="dz_an2sm" value="<?php echo $dz_an2sm;?>" onblur=" maxval(this,20);" onfocus="this.select()"/></td>
     <td  valign="top"><input type="number" class="form-control" step="any" name="dz_an1sm" value="<?php echo $dz_an1sm;?>" onblur="maxval(this,20); " onfocus="this.select()" /></td>
    <td valign="top">02</td>
  </tr>
    <tr>
   <td valign="top"><input type="text" class="form-control" name="tr_anmy" onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $tr_anmy;?>" /></td>
   <td  valign="top"><input type="number" class="form-control" step="any" name="tr_an2sm" value="<?php echo $tr_an2sm;?>" onblur="maxval(this,20); " onfocus="this.select()" /></td>
    <td valign="top"><input type="number" class="form-control" step="any" name="tr_an1sm" value="<?php echo $tr_an1sm;?>" onblur="maxval(this,20); " onfocus="this.select()"/></td>
    <td valign="top">03</td>
  </tr>
    <tr>
   <td  valign="top"><input type="text" class="form-control" name="qt_anmy" onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $qt_anmy;?>"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="qt_an2sm"  value="<?php echo $qt_an2sm;?>" onblur="maxval(this,20); "onfocus="this.select()"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="qt_an1sm"  value="<?php echo $qt_an1sm;?>" onblur="maxval(this,20); "onfocus="this.select()"/></td>
          <td valign="top">04</td>
  </tr>
  <tr>
     <td valign="top"><input type="text" class="form-control"  name="cq_anmy" onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $cq_anmy;?>"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="cq_an2sm"  value="<?php echo $cq_an2sm;?>" onblur="maxval(this,20);"onfocus="this.select()"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="cq_an1sm" value="<?php echo $cq_an1sm;?>" onblur="maxval(this,20); "onfocus="this.select()" /></td>
    <td valign="top">05</td>
  </tr>
   <tr>
    <td  valign="top"><input type="text" class="form-control" name="six_anmy"  onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $six_anmy;?>"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="six_an2sm" value="<?php echo $six_an2sm;?>" onblur="maxval(this,20); "onfocus="this.select()"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="six_an1sm" value="<?php echo $six_an1sm;?>" onblur="maxval(this,20); "onfocus="this.select()" /></td>
    <td valign="top">06</td>
  </tr>
   <tr>
   <td  valign="top"><input type="text" class="form-control" name="sept_anmy"  onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $sept_anmy;?>"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="sept_an2sm" value="<?php echo $sept_an2sm;?>" onblur=" maxval(this,20);)"onfocus="this.select()"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="sept_an1sm"  value="<?php echo $sept_an1sm;?>" onblur="maxval(this,20); "onfocus="this.select()" /></td>
    <td valign="top">07</td>
  </tr>
   <tr>
   <td  valign="top"><input type="text" class="form-control" name="huit_anmy" onblur="maxval(this,20); " onfocus="this.select()" id="txtf1" value="<?php echo $huit_anmy;?>"/></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="huit_an2sm" value="<?php echo $huit_an2sm;?>" onblur="maxval(this,20); "onfocus="this.select()" /></td>
         <td  valign="top"><input type="number" class="form-control" step="any" name="huit_an1sm"  value="<?php echo $huit_an1sm;?>" onblur=" maxval(this,20);"onfocus="this.select()"/></td>
    <td valign="top">08</td>
  </tr>
