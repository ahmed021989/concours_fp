...
<form  name="form1"   action="recours.php" class="registration-form" id="buttonGroupForm"  method="post">
...
<fieldset>
                                   <div class="col-sm-4 col-sm-offset-4 form-box" style="border:1px solid #99F;border-radius: 10px;">   
		                        	...
		                        	<div class="form-top" style="background-color:#26A69A">
		                        		...
		                        		<center>	<h3  style="color:#FFF">تسجيـــــل الدخول إلى الطعون </h3></center>
...
<div class="center-block"><u><a href="mail.php"> نسيت كلمة السر</a></u></div>
<br />
                  </div>
