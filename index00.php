...
if($auj<=$finab || $auj<=$date_fin_convb ){
	$test;
	$test1;
	$test2;
	if($auj<=$finab){
...
<?php
   ...
   <div class="alert alert-" style="background-color:#01DFD7">
<h4><b style="color:#040404"><u>المؤهلات و شروط المشاركة في المسابقة :  </u></b> </h4><br />
<span  id="test2">انقر هنا لمعرفة الشروط المشاركة في المسابقة</span><img src="doit.png" height="50" width="50" /><br />
  <a href="ats+agent bur.pdf" style="font-size:24px;color:#040404" class="fa fa-file-pdf-o " ><u>- مساعد تمريض الصحة العمومية (الترشح للمتخرجين من القطاع الخاص فقط) +عون مكتب(مستوى السنة الأولى ثانوي كاملة).</u> </a></br> <br />
<a href="CONCOURS2018.pdf" style="font-size:24px;color:#040404" class="fa fa-file-pdf-o " ><u>-  صيدلي عام + متصرف + بيولوجي للصحة العمومية + مهندس دولة في الاعلام الالي . </u></a> </br> <br /> 
<!--<a href="ats11.pdf" style="font-size:24px;color:#040404" class="fa fa-file-pdf-o " ><u>- مساعد تمريض للصحة العمومية(الترشح للمتخرجين من القطاع الخاص فقط). </u></a></br>  <br />
-->
