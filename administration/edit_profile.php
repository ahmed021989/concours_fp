...
if ( (isset($_GET['id'])) && (is_numeric($_GET['id'])) ) { 
	...
	$edit->type = htmlentities(trim($_POST['type']));
		switch ($edit->type) {
										case "sous-directeur":
										$edit->type_ar = "مديــــر فرعي";
											break;
										case "gestionnaire":
										$edit->type_ar = "مسييــــر";
											break;
										case "agent":
										$edit->type_ar = "عـــــون";
											break;										
									}
                                    ...
                                    <div class="form-group" style ="dir:rtl;" >
                                      ...
                                      <div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name ="excercice" class="form-control" required  style= "text-align:right;" value="<?php if (isset($edit->login)){ echo html_entity_decode($edit->excercice);} ?>" />
                                            </div>                                            
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12" >                                                                                            
                                            <select class="form-control select"required name="type"  style= "text-align:right;" >
                                                ...
                                                <option value = "sous-directeur" <?php if(isset($edit->type)&&($edit->type=="sous-directeur")){echo "selected";}?> >مديــــر فرعي</option>
                                                <option value = "gestionnaire" <?php if(isset($edit->type)&&($edit->type=="gestionnaire")){echo "selected";}?>>مسييــــر</option>
                                                <option value = "agent" <?php if(isset($edit->type)&&($edit->type=="agent")){echo "selected";}?>>عـــــون</option>
                                            </select>
                                        </div>
