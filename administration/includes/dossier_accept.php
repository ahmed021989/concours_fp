...
class Dossier_accept {
	
	protected static $nom_table="dossier_accept";
	protected static $champs = array('code','accept','cause');
	public $code;
	public $accept;
	public $cause;
  ...
  public function nom_compler() {
	...
	public static function trouve_tous() {
  	...
  	public static function trouve_tous1() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." where accept=\"oui\"");
  }
  
  public static function trouve_tous2() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." where accept=\"non\"");
  }
