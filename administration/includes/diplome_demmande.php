...
class Diplome_demmande {
	
	protected static $nom_table="diplome_demmande";
	protected static $champs = array('id','poste','diplome');
	public $id;
	public $poste;
	public $diplome;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE poste = '".$this->poste."' and diplome= '".$this->diplome."'";
