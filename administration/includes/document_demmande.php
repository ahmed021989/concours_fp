...
class Document_demmande {
	
	protected static $nom_table="document_demmande";
	protected static $champs = array('code','nom_doc_demmande','nbr','poste');
	public $code;
	public $nom_doc_demmande;
	public $nbr;
	public $poste;
  ...
  public  static  function  count_document(){
	 ...
	 $result_array = self::trouve_par_sql( "SELECT count(*) FROM ".self::$nom_table);
		
return !empty($result_array) ? mysql_num_rows($result_array): false;
	}
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE nom_doc_demmande = '".$this->nom_doc_demmande."' and poste='".$this->poste."'";
