...
class Filliere_demmande {
	
	protected static $nom_table="filliere_demmande";
	protected static $champs = array('id','poste','filliere');
	public $id;
	public $poste;
	public $filliere;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE poste = '".$this->poste."' and filliere= '".$this->filliere."'";
