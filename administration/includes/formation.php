...
class Formation {
	...
	protected static $nom_table="formation";
	protected static $champs = array('code','nature_diplome_f','filiere_f','specialite_f','etablissement_f','numero_diplome_f','date_diplome_f','date_f_de','date_f_jusqua','date_doctor');
	public $code;
	public $nature_diplome_f;
	public $filiere_f;
	public $specialite_f;
    public $etablissement_f;
    public $numero_diplome_f;
    public $date_diplome_f;
    public $date_f_de;
    public $date_f_jusqua;
    public $date_doctor;
