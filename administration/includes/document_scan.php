...
class Document_scan {
	...
	protected static $nom_table="document_scan";
	protected static $champs = array('code','nom_doc','lien_doc');
	public $code;
	public $nom_doc;
	public $lien_doc;
  ...
  public static  function trouve_par_id1($code) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE code ='{$code}' LIMIT 1 OFFSET 0");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
   public static  function trouve_par_id2($code) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE code ='{$code}' LIMIT 1 OFFSET 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
   public static  function trouve_par_id3($code) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE code ='{$code}' LIMIT 1 OFFSET 2");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
   public static  function trouve_par_id4($code) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE code ='{$code}' LIMIT 1 OFFSET 3");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
