...
class Employer {
	...
	protected static $champs = array('code','nom_emploie','date_emploie_initial','date_emploie_actuel','categorie','degre','numero_document','date_document','nature_signateur','adresse_administration','telephone_administration','fax_administration','email_administration');
	public $code;
	public $nom_emploie;
    public $date_emploie_initial;
	public $date_emploie_actuel;
	public $categorie;
	public $degre;
	public $numero_document;
	public $date_document;
	public $nature_signateur;
	public $adresse_administration;
	public $telephone_administration;
	public $fax_administration;
	public $email_administration;
  ...
  public static function trouve_par_id($id) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE Id_filiere ={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
