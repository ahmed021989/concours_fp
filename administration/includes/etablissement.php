...
class Etablissement {
	...
	protected static $champs = array('Id_etab','Nom_etab_fr','excercice','Add_etab_fr', 'Num_tele_01','Num_tele_02','Num_fax', 'Add_mail_etab','Nom_etab_ar','Add_etab_ar','Id_derc','Nom_direc_fr','Nom_direc_ar');
	public $Id_etab;
	public $Nom_etab_fr;
	public $excercice;
	public $Add_etab_fr;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE Nom_etab_fr = '".$this->Nom_etab_fr."' ";
	...
	public static function trouve_tous() {
		 $result_array= self::trouve_par_sql("SELECT * FROM ".self::$nom_table." LIMIT 1");
	return !empty($result_array) ? array_shift($result_array) : false;
  }
