...
class Parcours1 {
	...
	protected static $nom_table="parcours1";
	protected static $champs = array('code','mention_diplome','anne_major','n_piece_major','date_piece_major','pr_an1sm','pr_an2sm','pr_anmy','dz_an1sm','dz_an2sm','dz_anmy','tr_an1sm','tr_an2sm','tr_anmy','qt_an1sm','qt_an2sm','qt_anmy','cq_an1sm','cq_an2sm','cq_anmy','six_an1sm','six_an2sm','six_anmy','sept_an1sm','sept_an2sm','sept_anmy','huit_an1sm','huit_an2sm','huit_anmy','moyen_general','note_memoire');
	public $code;
	public $mention_diplome;
	public $anne_major;
	public $n_piece_major;
	public $date_piece_major;
