...
class Experiance {
	...
	protected static $nom_table="experiance";
	protected static $champs = array('code','etablis_experiance','grade_experiance','date_experiance_de','date_experiance_jusqua','numero_attestation','date_attestation','cause_fin_relation');
	public $code;
	public $etablis_experiance;
	public $grade_experiance;
	public $date_experiance_de;
	public $date_experiance_jusqua;
	public $numero_attestation;
	public $date_attestation;
	public $cause_fin_relation;
