...
class Diplome {
	...
	protected static $champs = array('code','nom_diplom','nom_filiere','nom_specialite','numero_diplome','date_diplome','dure_diplomeA','dure_diplomeM','dure_diplome_de','dure_diplome_jusqua','etablis_diplome','Nom_filiere');
	public $code;
	public $nom_diplom;
	public $nom_filiere;
	public $nom_specialite;
	public $numero_diplome;
	public $date_diplome;
	public $dure_diplomeA;
	public $dure_diplomeM;
	public $dure_diplome_de;
	public $dure_diplome_jusqua;
	public $etablis_diplome;
