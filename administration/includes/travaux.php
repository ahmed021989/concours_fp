...
class Travaux {
	...
	protected static $nom_table="travaux";
	protected static $champs = array('code','nature_travail','date_publication','nom_journal_publication','numero_journal_publication','date_journal_publication');
	public $code;
	public $nature_travail;
	public $date_publication;
	public $nom_journal_publication;
	public $numero_journal_publication;
