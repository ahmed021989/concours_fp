...
if ( (isset($_GET['id'])) && (is_numeric($_GET['id'])) ) { 
	...
	$edit->date_convocation = htmlentities(trim($_POST['date_convocation']));
	...
	if (empty($errors)){
 		...
 		if ($edit->save()){
		$msg_positif .= '<p style= "font-size: 20px; ">    تم تسجيل تاريخ المسابقة "  ' . html_entity_decode($edit->date_convocation) . ' " بنجاح  </p><br />';
		}else{
...
?>
                ...
                <div class="page-title">                    
                    <h2>تاريخ المسابقة <span class="fa fa-plus-square"></span> </h2>
                </div>   
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls">
                                        <li> <h3 class="panel-title"><strong> المعلــومــات الخــاصة بتاريخ المسابقة</strong></h3></li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">   
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name ="Nom_poste" class="form-control" required  style= "text-align:right;color : #F74B4B;" value = "<?php echo $edit->Nom_poste;?>"  disabled />
                                            </div>                                            
                                        </div>
									...
									<div class="form-group">                                        
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="date_convocation" class="form-control" required  style= "text-align:left;"value = "<?php echo $edit->date_convocation;?>" />
                                            </div>                                            
                                          
                                        </div>          
                                        
                                        <label class="col-md-3 col-xs-12 control-label">تاريخ المسابقة</label>
                                    </div> 
