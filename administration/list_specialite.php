...
?><?php 
$titre = "التخصصات المطلوبة";
$active_menu = "index";
$header = array('specialite');
...
?>
                ...
                <div class="page-title">                    
                    <h2>قائمة التخصصات حسب المنصب <span class="fa fa-cogs"></span> </h2>
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">قائمة التخصصات المطلوبة  </h3>
	...
	if(	$specialite_demmande = Specialite_demmande::trouve_par_sql("select * from specialite_demmande where poste='".$poste->Nom_poste."'")){		
									
								?>
                                            <tr id="<?php echo $poste->Id_poste; ?>">
											<td>
					
										    <a href="edit_specialite_demmande.php?id=<?php echo $poste->Id_poste; ?>" class="btn btn-info btn-rounded "> <span class="fa fa-pencil"></span></a>
                                            										  
											</td>
										 
										   	 <td><strong> <table  class="table table-bordered" ><tr ><?php foreach($specialite_demmande as $specialite_demmande1){ echo "<td>".$specialite_demmande1->specialite."</td>";} ?></tr></table></strong></td>
                                   ...
                                   <?php
									...
									?>
								      <tr id="<?php echo $poste->Id_poste; ?>">
										    ...
										    <a href="edit_specialite_demmande.php?id=<?php echo $poste->Id_poste; ?>" class="btn btn-info btn-rounded "> <span class="fa fa-plus"></span></a>
