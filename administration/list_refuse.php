...
?>
                ...
                <div class="page-title">                    
                    <h2>  قائمة الملفات المرفوضة لسنة <?php echo $user->excercice; ?>&nbsp;&nbsp;<span class="fa fa-file-text"></span></h2> 
 ...
 <thead> <th>اسم المستخدم</th><th>الاسم واللقب</th><th>المنصب المشارك فيه</th><th>سبب الرفض</th></thead><tbody>
 <?php
 foreach($dossier_accepts as  $dossier_accept){
   if( $condidat= Condidat::trouve_par_id_excercice($dossier_accept->code,$user->excercice)){
	...
	echo "<tr><td>".$condidat->code."</td><td>".$condidat->nom_compler()."</td><td>".$condidat->grade."</td><td>".$dossier_accept->cause."</td></tr>";
	//echo $recour->contenu;
 ...
 ?>
           <form class="form-horizontal" role="form"  name="ajout_admin" action="liste_refuser_word.php" method="post">
<select class="form-control  pull-right" id="01" name="select_refuse" style="width:40%;font-weight:bold;text-align:center" > 
