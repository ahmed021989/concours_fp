...
if ( (isset($_GET['id'])) ) { 
	...
	$edit->note_deplom = htmlentities(trim($_POST['note_deplom']));
	$edit->note_exame = htmlentities(trim($_POST['note_exame']));
	$edit->note_date_deplom = htmlentities(trim($_POST['note_date_deplom']));
	$edit->note_relve_note = htmlentities(trim($_POST['note_relve_note']));
	$edit->note_experiance = htmlentities(trim($_POST['note_experiance']));
	$edit->note_majour = htmlentities(trim($_POST['note_majour']));
	$edit->note_ecole_sup = htmlentities(trim($_POST['note_ecole_sup']));
	$edit->note_forma_comple = htmlentities(trim($_POST['note_forma_comple']));
	$edit->note_etud_realise = htmlentities(trim($_POST['note_etud_realise']));
	...
	if (empty($errors)){
 		...
 		if ($edit->save()){
		$msg_positif .= '<p style= "font-size: 20px; ">   تم تحديث النقاط بنجاح   </p><br />';
		}else{
...
?>
                ...
                <div class="page-title">                    
                    <h2> تعديل النقاط <span class="fa fa-pencil-square-o"></span>   </h2>
								...
								<div class="form-group" style ="dir:rtl;" >
									...
									<div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="note_deplom"  min="1" max="6"  oninvalid="this.setCustomValidity('حقل اجباري ؟ في حدود 6 نقاط ')" oninput="setCustomValidity('');" class="form-control" required  style= "text-align:right;" value = "<?php echo $edit->note_deplom;?>"/>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_exame" min="0" max="3" oninvalid="this.setCustomValidity('حقل إجباري ؟ في حدود 3 نقاط')" oninput="setCustomValidity('');" class="form-control" required  style= "text-align:right;" value = "<?php echo $edit->note_exame;?>"/>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_date_deplom" min="0" max="5" oninvalid="this.setCustomValidity('حقل إجباري ؟ في حدود 5 نقاط')" oninput="setCustomValidity('');" class="form-control" required  style= "text-align:right;" value = "<?php echo $edit->note_date_deplom;?>"/>
									...
									<div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_relve_note" min="0" max="7" oninvalid="this.setCustomValidity('حقل إجباري ؟ في حدود 7 نقاط')" oninput="setCustomValidity('');" class="form-control" required  style= "text-align:right;" value = "<?php echo $edit->note_relve_note;?>"/>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_experiance" min="0" max="6" oninvalid="this.setCustomValidity('في حدود 6 نقاط')" oninput="setCustomValidity('');" class="form-control"  style= "text-align:right;" value = "<?php echo $edit->note_experiance;?>"/>
                                    ...
                                    <div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_majour" min="1" max="1" oninvalid="this.setCustomValidity('في حدود نقطة واحدة ')" oninput="setCustomValidity('');" class="form-control"  style= "text-align:right;" value = "<?php echo $edit->note_majour;?>"/>
									...
									<div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_ecole_sup" min="2" max="2" oninvalid="this.setCustomValidity('في حدود  نقطتين')" oninput="setCustomValidity('');" class="form-control"  style= "text-align:right;" value = "<?php echo $edit->note_ecole_sup;?>"/>
									...
									<div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_forma_comple" min="0" max="2" oninvalid="this.setCustomValidity('في حدود  نقطتين')" oninput="setCustomValidity('');" class="form-control"   style= "text-align:right;" value = "<?php echo $edit->note_forma_comple;?>"/>
									...
									<div class="form-group" style ="dir:rtl;" >
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                 <span class="input-group-addon">نقطة</span>
                                                <input type="number" name="note_etud_realise" min="0" max="2"  oninvalid="this.setCustomValidity('في حدود  نقطتين')" oninput="setCustomValidity('');" class="form-control"   style= "text-align:right;" value = "<?php echo $edit->note_etud_realise;?>"/>
												<span class="input-group-addon">من 00 إلى 02</span>
                                            </div>                                            
