...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": تفعيل لفرز العمود تصاعدي",sSortDescending:": تفعيل لفرز عمود تنازلي"},oPaginate:{sFirst:"الأول",sLast:"الأخير",sNext:"التالي",sPrevious:"السابق"},
sEmptyTable:"لا توجد بيانات في الجدول",sInfo:" إظهار _START_  من _END_ إلى _TOTAL_ إدخالات",sInfoEmpty:"عرض من 0الى  0إدخالات",sInfoFiltered:"(تمت تصفيتها من _MAX_ إجمالي الإدخالات)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ الإدخالات",sLoadingRecords:"...الرجاء الإنتظار",sProcessing:"...معالجة",sSearch:"بحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لم يتم العثور على سجلات مطابقة"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"بيانات",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
