...
?><?php 
$titre = "الشهادات المطلوبة";
$active_menu = "index";
$header = array('diplome');
...
?>
                ...
                <div class="page-title">                    
                    <h2>قائمة الشهادات حسب المنصب <span class="fa fa-cogs"></span> </h2>
					 <a href="ajouter_diplome_demmande.php"><button type="button" class="btn btn-success "> إضــافة شهادة </button></a>
                </div>                   
                		<?php 
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">قائمة الشهادات المطلوبة  </h3>
	...
	if(	$diplome_demmande = Diplome_demmande::trouve_par_sql("select * from diplome_demmande where poste='".$poste->Nom_poste."'")){		
									
								?>
                                            <tr id="<?php echo $poste->Id_poste; ?>">
											<td>
					
										    <a href="edit_diplome_demmande.php?id=<?php echo $poste->Id_poste; ?>" class="btn btn-info btn-rounded "> <span class="fa fa-pencil"></span></a>
                                            										  
											</td>
										 
										   	 <td><strong> <table  class="table table-bordered" ><tr ><?php foreach($diplome_demmande as $diplome_demmande1){ echo "<td>".$diplome_demmande1->diplome."</td>";} ?></tr></table></strong></td>
                                   ...
                                   <?php
									...
									?>
								      <tr id="<?php echo $poste->Id_poste; ?>">
										    ...
										    <a href="edit_diplome_demmande.php?id=<?php echo $poste->Id_poste; ?>" class="btn btn-info btn-rounded "> <span class="fa fa-plus"></span></a>
