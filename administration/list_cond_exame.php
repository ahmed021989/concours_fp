...
?>
                ...
                <div class="page-title">                    
                    <h2>قائمة المناصب <span class="fa fa-cogs"></span> </h2>
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
								...
								?>
											...
											<td>
												    <button class="btn btn-danger btn-rounded " onClick="delete_row('<?php echo $poste->Id_poste; ?>');"><span class="glyphicon glyphicon-trash"></span></button>
