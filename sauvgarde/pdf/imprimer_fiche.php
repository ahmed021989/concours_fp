...
$htmlpersian = '<h2 ><br><br><table border="0"><tr><td style="width:85%"><p align="center">الجمهوريــة الجزائريــة الديمقراطيـة الشعبيـة <br>نموذج رقم (02)<br>استمارة معلومات للمشاركة في المسابقة على أساس الشهادة
  <br />
للإلتحاق برتبة : 
';
$nom="";
...
$htmlpersian.=$row["grade"].'
</p></td><td style="width:15%;" border="1 solid black"><p align="center"><br>صورة</p></td></tr></table>';
}
...
if($sexe=="أنثى"){
	$htmlpersian.='<span dir="ltr">: عنوان البريد الإلكتروني -  </span><span dir="rtl"> '. $email .'</span><br />';
}else{
