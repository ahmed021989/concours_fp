...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 06 Novembre 2019 à 09:03
...
CREATE TABLE IF NOT EXISTS `compte` (
  `email` varchar(200) CHARACTER SET cp1256 NOT NULL,
...
--
-- Structure de la table `diplome_demmande`
--

CREATE TABLE IF NOT EXISTS `diplome_demmande` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `poste` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `diplome` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`,`poste`,`diplome`)
...
--
-- Structure de la table `document_demmande`
--

CREATE TABLE IF NOT EXISTS `document_demmande` (
  `code` int(11) NOT NULL,
  `nom_doc_demmande` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Structure de la table `document_scan`
--
...
--
-- Structure de la table `dossier_accept`
--
...
CREATE TABLE IF NOT EXISTS `etablissement` (
  ...
  `excercice` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `etablissement` (`Id_etab`, `Nom_etab_fr`, `excercice`, `Add_etab_fr`, `Num_tele_01`, `Num_tele_02`, `Num_fax`, `Add_mail_etab`, `Nom_etab_ar`, `Add_etab_ar`, `Id_derc`, `Nom_direc_fr`, `Nom_direc_ar`) VALUES
(2, 'EPH NOM ETABLISSEMENT', '2019', 'العنوان بالفرنسية', 0, 0, 0, 'exemple@gmail.com', '- المؤسسة العمومية الإستشفائية  - الاسم', 'العنوان', 3, 'المدير بالفرنسية', 'اسم المدير');
...
--
-- Structure de la table `filliere_demmande`
--

CREATE TABLE IF NOT EXISTS `filliere_demmande` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `poste` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `filliere` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`,`poste`,`filliere`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Structure de la table `parcours1`
--
...
INSERT INTO `personne` (`id`, `login`, `mot_passe`, `excercice`, `nom`, `prenom`, `nom_ar`, `date_naissance`, `lieu_naissance`, `type`, `type_ar`, `adresse`, `email`, `telephone`) VALUES
(2, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '2019', 'ahmed', 'zerarka', 'زرارقة أحمد', '1989-04-11', 'ابوالحسن - الشلف', 'administrateur', 'مديــــر فرعي', 'ابوالحسن - الشلف', 'zerarkahmedtpgr@live.fr', '0069 95 51 97');
...
CREATE TABLE IF NOT EXISTS `poste` (
  ...
  `Nom_poste` varchar(100) CHARACTER SET cp1256 NOT NULL,
  `nb_poste` int(10) NOT NULL,
  `excercice` varchar(11) CHARACTER SET cp1256 NOT NULL,
  `Date_debut` date NOT NULL,
  `Date_fin` date NOT NULL,
  ...
  PRIMARY KEY (`Nom_poste`,`excercice`),
...
CREATE TABLE IF NOT EXISTS `recours` (
  `code` varchar(150) CHARACTER SET cp1256 NOT NULL,
  `contenu` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `lien_doc` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `date_recour` date NOT NULL,
  `heure_recour` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Structure de la table `specialite_demmande`
--

CREATE TABLE IF NOT EXISTS `specialite_demmande` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `poste` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `specialite` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`,`poste`,`specialite`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
ALTER TABLE `condidat`
  ADD CONSTRAINT `condidat_ibfk_1` FOREIGN KEY (`code`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `diplome`
--
ALTER TABLE `diplome`
  ADD CONSTRAINT `diplome_ibfk_1` FOREIGN KEY (`code`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `employer`
--
ALTER TABLE `employer`
  ADD CONSTRAINT `employer_ibfk_1` FOREIGN KEY (`code`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `experiance`
--
ALTER TABLE `experiance`
  ADD CONSTRAINT `experiance_ibfk_1` FOREIGN KEY (`user`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `formation`
--
ALTER TABLE `formation`
  ADD CONSTRAINT `formation_ibfk_1` FOREIGN KEY (`user`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `parcours1`
--
ALTER TABLE `parcours1`
  ADD CONSTRAINT `parcours1_ibfk_1` FOREIGN KEY (`code`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `recours`
--
ALTER TABLE `recours`
  ADD CONSTRAINT `recours_ibfk_1` FOREIGN KEY (`code`) REFERENCES `compte` (`email`);

--
-- Contraintes pour la table `travaux`
--
ALTER TABLE `travaux`
  ADD CONSTRAINT `travaux_ibfk_1` FOREIGN KEY (`user`) REFERENCES `compte` (`email`);
